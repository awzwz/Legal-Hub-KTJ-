...
import { mockNotifications, availableUsers, roleLabels, canViewAuditLog, canViewAllAnalytics } from "@/data/mockData";
...
const getNavItems = (user: UserType): NavItem[] => {
  const items: NavItem[] = [
  ...
  items.push(
    ...
    { icon: Bell, label: "Уведомления", id: "notifications", badge: mockNotifications.filter(n => !n.read).length },
  );
