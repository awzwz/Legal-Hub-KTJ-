...
const rows = [
  ["45%", "Результат", "качество исходов: полное удовлетворение, частичное удовлетворение, мировое соглашение, отказ"],
      ...
      <PopoverContent align="end" className="w-[360px] text-sm">
        <div className="space-y-3">
          ...
          <p className="rounded-md bg-slate-50 p-2 text-xs text-slate-600">
            Для результата применяется поправка на малую выборку: юрист с одним выигранным делом
            не должен автоматически быть выше юриста с большим устойчивым портфелем.
          </p>
        </div>
      </PopoverContent>
    </Popover>
